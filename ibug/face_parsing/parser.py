...
class FaceParser(object):
    def __init__(self, device='cuda:0', ckpt=None, encoder='rtnet50', decoder='fcn', num_classes=11):
        ...
        print('---- FaceParser ----')
        print(model_name, pretrained_ckpt) # resnet50-fcn-14 /Users/wanghui/Desktop/6-work/D24H-fulltime/work/14-age_woman/fpage/ibug/face_parsing/resnet/weights/resnet50-fcn-14.torch
        self.sz = sz
        ...
        print(ckpt) # /Users/wanghui/Desktop/6-work/D24H-fulltime/work/14-age_woman/fpage/ibug/face_parsing/resnet/weights/resnet50-fcn-14.torch
        ckpt = torch.load(ckpt, 'cpu') # error: _pickle.UnpicklingError: invalid load key, 'v'
